...
public final class TooManyChestsClient {
    ...
    public static void init(IEventBus modEventBus) {
        ...
        MinecraftForge.EVENT_BUS.addListener(TooManyChestsClient::onClientTick);
        MinecraftForge.EVENT_BUS.addListener(TooManyChestsClient::onRightClickBlock);
        MinecraftForge.EVENT_BUS.addListener(TooManyChestsClient::onRenderLevelStage);
        MinecraftForge.EVENT_BUS.addListener(TooManyChestsClient::onRenderGuiPost);
        MinecraftForge.EVENT_BUS.addListener(TooManyChestsClient::onClientLogout);
